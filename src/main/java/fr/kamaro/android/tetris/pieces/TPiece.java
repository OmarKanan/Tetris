...
public class TPiece extends AbstractPiece {
    ...
    public TPiece(Context context) {
        this.color = context.getResources().getColor(R.color.tpiece_color);
    ...
    public Block[] setBlocks() {
        ...
        b[3] = new Block(5, 2, color);
        return b;
    }

    @Override
    public AbstractPiece createCopyPiece() {
        AbstractPiece copyPiece = new TPiece();
    ...
    public Block[] blocksAfterRotation() {
        ...
        if (orientation == 1) {
            ...
            b[1] = new Block(blocks[1].getWPosition(), blocks[1].getHPosition() + 1, color);
            b[2] = new Block(blocks[2].getWPosition() - 1, blocks[2].getHPosition(), color);
            b[3] = new Block(blocks[3].getWPosition() + 1, blocks[3].getHPosition(), color);
        }
        if (orientation == 2) {
            ...
            b[2] = new Block(blocks[2].getWPosition(), blocks[2].getHPosition() - 2, color);
        ...
        if (orientation == 3) {
            ...
            b[2] = new Block(blocks[2].getWPosition() + 2, blocks[2].getHPosition() + 1, color);
